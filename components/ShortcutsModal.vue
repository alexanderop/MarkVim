  ...
  >
    ...
    <div class="gap-6 grid grid-cols-1 md:grid-cols-2">
      <div
        ...
        class="space-y-3"
      >
        <h3 class="text-xs text-text-tertiary tracking-wider font-medium uppercase">
          {{ category.name }}
        </h3>
          ...
          >
            ...
            <div class="flex items-center space-x-1">
              <kbd
                ...
                :key="index"
                class="text-xs text-text-primary font-mono px-1.5 border border-subtle rounded bg-surface-secondary inline-flex h-6 min-w-[1.5rem] shadow-sm items-center justify-center" :class="[
    ...
    <template #footer-left>
      Press <kbd class="text-xs text-text-primary font-mono px-1 border border-subtle rounded bg-surface-secondary inline-flex h-5 min-w-[1.5rem] items-center justify-center">⎋</kbd> to close
    </template>
