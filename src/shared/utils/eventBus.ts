import type { ColorThemeEvents } from '@modules/color-theme'
import type { DocumentsEvents } from '@modules/documents'
import type { EditorEvents } from '@modules/editor'
import type { ShortcutsEvents } from '@modules/shortcuts'
